...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 class="modal-title">{{ trans('admin/classificationlevel/table.create') }}</h4>
        </div>
        <div class="modal-body">
            <form action="{{ route('api.classificationlevel.store') }}" onsubmit="return false">
                ...
                <div class="dynamic-form-row">
                    <div class="col-md-4 col-xs-12"><label for="modal-type">{{ trans('admin/classificationlevel/table.classification_type') }}:
                        </label></div>
