...
<div class="form-group {{ $errors->has('classification_level') ? ' has-error' : '' }}">
    <label for="classification_level" class="col-md-3 control-label">{{ $translated_name }}</label>
    <div class="col-md-7 col-sm-11">
        {{ Form::select('classificationlevel', $array , old('classificationlevel', $item->classificationlevel), array('class'=>'select2 classificationlevel', 'style'=>'width:100%','id'=>'classificationlevel', 'aria-label'=>'classificationlevel')) }}
