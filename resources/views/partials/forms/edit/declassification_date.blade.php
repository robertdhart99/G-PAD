...
<div class="form-group{{ $errors->has('declassification_date') ? ' has-error' : '' }}">
    ...
    <div class="input-group col-md-3">
        <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd"  data-autoclose="true">
            <input type="text" class="form-control" placeholder="{{ trans('general.select_date') }}" name="declassification_date" id="declassification_date" value="{{ old('declassification_date', ($item->declassification_date) ? Carbon\Carbon::parse($item->declassification_date)->format('Y-m-d') : '') }}">
