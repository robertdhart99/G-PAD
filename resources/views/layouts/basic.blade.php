...
<body class="hold-transition login-page">
  ...
  @yield('content')
    ...
    @endif
    <p><strong><bold>Standard Mandatory DoD Notice and Consent</bold></strong>
    <bold>You are accessing a U.S. Government (USG) Information System (IS) that is provided for USGauthorized use only.</bold><br>
    <bold>By using this IS (which includes any device attached to this IS), you consent to the following conditions:</bold><br>
    <ul>
